            ...
            <span className="icon-games" style={{
                ...
                backgroundSize: "200% auto",
                    ...
                    <h1 style={{
                        ...
                        fontSize: 48,
                        fontWeight: 300,
                    }}>Thank you for installing Kornet.</h1>
                    <span style={{
                        width: "500px",
                        margin: "50px auto",
                        fontSize: 16,
                        ...
                        textAlign: "center",
                        lineHeight: "1.5em",
                    }}>It"s time to play! You can now browse and play the most popular games on Kornet.</span>
                    <Link href="/games">
                        <a href="/games">
                            <ActionButton label="Browse Kornet Games" buttonStyle={buttonStyles.newBuyButton}
