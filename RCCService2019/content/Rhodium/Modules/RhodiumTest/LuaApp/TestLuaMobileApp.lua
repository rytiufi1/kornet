...
local HomepagePeopleList = require(script.Parent.Modules.HomepagePeopleList)

local function test()
	describe.protected("Mobile Place Rhodium Test", function()
		include(HomePageLoad)
		include(HomepagePeopleList)
...
-- avatar test are too flakey between phone and tablet
		-- include(AvatarTest)
	end)
end
