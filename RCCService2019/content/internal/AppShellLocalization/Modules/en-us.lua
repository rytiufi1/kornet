local enUS =
{
	...
	["ReauthMaintenanceTitle"] = "Under Maintenance";
	["ReauthMaintenancePhrase"] = "We are currently undergoing maintenance and should be back up soon.";
	...
	--Sponsored Games
	["SponsoredGameWord"] = "Sponsored Game";
}
