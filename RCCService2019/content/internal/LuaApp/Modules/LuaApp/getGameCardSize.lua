...
local function getCardFooterHeight(width)
	if width < 100 then
		return 55
...
local function getGameCardSize(containerWidth, containerPadding, cardPadding, trailingCardFraction)
	...
	cardWidth = math.floor((containerWidth - cardPadding * paddingCount)/cardCount)
	cardHeight = math.floor(cardWidth + getCardFooterHeight(cardWidth))
