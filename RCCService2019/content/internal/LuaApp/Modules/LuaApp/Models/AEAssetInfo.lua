...
function AEAssetInfo.fromWebApi(assetInfo, assetType)
	...
	assetTable.assetId = tostring(assetInfo.Item.AssetId)
	assetTable.assetType = tostring(assetType)
...
function AEAssetInfo.fromWebOutfitApi(assetInfo, assetType)
	...
	assetTable.assetId = tostring(assetInfo.id)
	assetTable.assetType = tostring(assetType)
	assetTable.receivedMarketPlaceInfo = false
...
function AEAssetInfo.fromGetAvatarDataApi(asset)
	...
	assetTable.description = ""
	assetTable.creatorName = ""
	assetTable.assetId = tostring(asset.id)
	assetTable.assetType = tostring(asset.assetType.id)
	assetTable.receivedMarketPlaceInfo = false
...
function AEAssetInfo.fromGrantSignal(assetTypeId, assetId)
	...
	assetTable.description = ""
	assetTable.creatorName = ""
	assetTable.assetId = tostring(assetId)
	assetTable.assetType = tostring(assetTypeId)
	assetTable.receivedMarketPlaceInfo = false
...
function AEAssetInfo.fromGetRecentItemsApi(assetData)
	...
	assetTable.description = ""
	assetTable.creatorName = ""
	assetTable.assetId = tostring(assetData.id)
	assetTable.assetType = assetData.assetType and tostring(assetData.assetType.id) or AEConstants.OUTFITS
	assetTable.receivedMarketPlaceInfo = false
