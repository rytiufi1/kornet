	...
	if UseNewAppStyle then
		return withStyle(function(style)
			return Roact.createElement(FitChildren.FitImageButton, {
				...
				BackgroundColor3 = buttonPressed and
					style.Theme.BackgroundOnHover.Color or
					style.Theme.BackgroundUIDefault.Color,
				BackgroundTransparency = buttonPressed and
					style.Theme.BackgroundOnHover.Transparency or
					style.Theme.BackgroundUIDefault.Transparency,
				BorderSizePixel = 0,
				...
				Icon = Roact.createElement("Frame", {
					Size = UDim2.new(0, iconFrameWidth, 0, ICON_SIZE),
					...
					Image = Roact.createElement(ImageSetLabel, {
						...
						Position = UDim2.new(0, ICON_HORIZONTAL_SPACE, 0, 0),
						BackgroundTransparency = 1,
						BorderSizePixel = 0,
