...
local SEARCH_FRAME_IMAGE = "LuaApp/9-slice/gr-search"
local SEARCH_BAR_ICON = "LuaApp/icons/ic-search"
local CLEAR_BUTTON_IMAGE = "LuaApp/icons/ic-clear"

if UseNewAppStyle then
	SEARCH_BAR_ICON  = "LuaApp/icons/ic-search-new"
	SEARCH_FRAME_IMAGE = {
		Image = "LuaApp/buttons/buttonFill",
		SliceCenter = Rect.new(8, 8, 9, 9),
	}
	CLEAR_BUTTON_IMAGE = "LuaApp/icons/common_clear_small"
end
