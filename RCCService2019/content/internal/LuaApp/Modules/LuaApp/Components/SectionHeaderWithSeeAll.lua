...
local SEE_ALL_BUTTON_ASSET_DEFAULT = "LuaApp/9-slice/gr-btn-blue-3px"
local SEE_ALL_BUTTON_ASSET_PRESSED = "LuaApp/9-slice/gr-btn-blue-3px-pressed"

SectionHeaderWithSeeAll.defaultProps = {
...
function SectionHeaderWithSeeAll:render()
	...
	local seeAllButtonVisible = self.props.seeAllButtonVisible
	...
	return Roact.createElement(FitChildren.FitFrame, {
		...
		Spacer = Roact.createElement("Frame", {
			...
			Button = seeAllButtonVisible and Roact.createElement(ImageSetButton, {
