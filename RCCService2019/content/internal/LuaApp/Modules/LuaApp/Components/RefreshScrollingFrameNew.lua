--[[
	...
	refresh -- refresh function for this page, needs to be a promise.
...
local Spinner = require(Modules.LuaApp.Components.Spinner)
...
function RefreshScrollingFrameNew:init()
	...
	self.onCanvasPositionChanged = function(rbx)
		...
		if self.isUserInteracting and not self.state.isRefreshing then
