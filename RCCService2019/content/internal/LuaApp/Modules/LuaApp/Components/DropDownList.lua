...
local FFlagLuaAppFixDropdownLabelOverflow = settings():GetFFlag("LuaAppFixDropdownLabelOverflow")
local UseNewAppStyle = FlagSettings.UseNewAppStyle()

local DROPDOWN_HEIGHT = 38
local DROPDOWN_ARROW_MARGIN = 7
local DROPDOWN_ARROW_SIZE
...
local DROPDOWN_BUTTON_BACKGROUND_IMAGE
local DROPDOWN_BUTTON_BORDER_IMAGE
local DROPDOWN_BUTTON_ARROW_IMAGE

if UseNewAppStyle then
	DROPDOWN_BUTTON_BACKGROUND_IMAGE = {
		Image = "LuaApp/buttons/buttonFill",
		SliceCenter = Rect.new(8, 8, 9, 9),
	}
	DROPDOWN_BUTTON_BORDER_IMAGE = {
		Image = "LuaApp/buttons/buttonStroke",
		SliceCenter = Rect.new(8, 8, 9, 9),
	}
	DROPDOWN_BUTTON_ARROW_IMAGE = "LuaApp/icons/dropdown_arrowDown"
	DROPDOWN_ARROW_SIZE = 20
else
	DROPDOWN_BUTTON_BACKGROUND_IMAGE = "LuaApp/9-slice/input-default"
	DROPDOWN_BUTTON_ARROW_IMAGE = "LuaApp/icons/ic-arrow-down"
	DROPDOWN_ARROW_SIZE = 12
end
		...
		return withStyle(function(style)
			return Roact.createElement(ImageSetButton, {
				...
				Text = Roact.createElement("TextLabel", {
					...
					ClipsDescendants = FFlagLuaAppFixDropdownLabelOverflow and true or nil,
					TextTruncate = FFlagLuaAppFixDropdownLabelOverflow and Enum.TextTruncate.AtEnd or nil,
				}),
