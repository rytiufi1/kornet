...
MEASUREMENT_CONSTANTS.PRESENCE = {
	...
	BORDER_DIAMETER = 14,
	-- ICON_OFFSET not needed if using FFUseAssetsWithBorderForPresence (when removing flag it should be set to 0)
	ICON_OFFSET = FFUseAssetsWithBorderForPresence and 0 or 5,
	ICON_SIZE = 24,
}
