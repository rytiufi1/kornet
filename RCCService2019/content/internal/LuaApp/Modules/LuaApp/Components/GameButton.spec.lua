return function()
	...
	it("should create and destroy without errors when store isn't provided and loading indicator is enabled", function()
		local emptyStore = Rodux.Store.new(AppReducer)
