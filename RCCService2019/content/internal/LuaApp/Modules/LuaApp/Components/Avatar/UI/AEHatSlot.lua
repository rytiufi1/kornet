...
function AEHatSlot:render()
	...
	local themeInfo = FFlagAvatarEditorEnableThemes and
			self._context.AvatarEditorTheme.AEHatSlot:getThemeInfo(deviceOrientation, themeName) or nil
	local index = self.props.index
	local equippedHats = self.props.equippedHats
	...
	if FFlagAvatarEditorEnableThemes then
		fadedHatIcon.imageRectOffset = nil
		fadedHatIcon.imageRectSize = nil
	end
	...
	return Roact.createElement("ImageButton", {
		...
		BorderColor3 = FFlagAvatarEditorEnableThemes and themeInfo.ColorTheme.Background or Color3.fromRGB(204, 204, 204),

		[Roact.Ref] = self.hatSlotRef,
		[Roact.Event.Activated] = activateFunction,
		[Roact.Event.TouchLongPress] = longPressFunction,
	}, {
		fadeIcon = Roact.createElement(FFlagAvatarEditorEnableThemes and ImageSetLabel or "ImageLabel", {
				Visible = fadeVisible,
				Position = UDim2.new(.25, 0, .25, 0),
				Size = UDim2.new(0, View[deviceOrientation].SIZE / 2, 0, View[deviceOrientation].SIZE / 2),
				BackgroundTransparency = 1,
				Image = FFlagAvatarEditorEnableThemes and 'AE/Icons/ic-hat' or fadedHatIcon.image,
				ImageColor3 = FFlagAvatarEditorEnableThemes
					and themeInfo.ColorTheme.PlaceHolderImageColor or Color3.fromRGB(255, 255, 255),
