...
function AEAssetOptionsMenu:render()
	...
	return Roact.createElement("Frame", {
		...
		BackgroundColor3 = FFlagAvatarEditorEnableThemes
			and themeInfo.ColorTheme.AssetOptionsMenu.BackgroundColor or Constants.Color.WHITE,
		...
		AssetNameFrame = Roact.createElement("Frame", {
			...
			AssetNameLabel = Roact.createElement("TextLabel", {
				...
				TextColor3 = FFlagAvatarEditorEnableThemes
					and themeInfo.ColorTheme.AssetOptionsMenu.TextColor or Color3.fromRGB(0, 0, 0),
				Size = UDim2.new(0.9, 0, 0.5, 0),
				TextScaled = true,
				BorderSizePixel = 0,
				BackgroundColor3 = FFlagAvatarEditorEnableThemes
					and themeInfo.ColorTheme.AssetOptionsMenu.BackgroundColor or Color3.new(1,1,1),
				Font = FFlagAvatarEditorGothamFont and themeInfo.ColorTheme.Text.FontBold or Enum.Font.SourceSans,
		...
		NameDivider = Roact.createElement("Frame", {
			BackgroundColor3 = FFlagAvatarEditorEnableThemes
				and themeInfo.ColorTheme.AssetOptionsMenu.SectionDividerColor or Constants.Color.ORANGE,
		...
		EquipDivider = Roact.createElement("Frame", {
			BackgroundColor3 = FFlagAvatarEditorEnableThemes
				and themeInfo.ColorTheme.AssetOptionsMenu.SubSectionDividerColor or Constants.Color.GRAY_SEPARATOR,
