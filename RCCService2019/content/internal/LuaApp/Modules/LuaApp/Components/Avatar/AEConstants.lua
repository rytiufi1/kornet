...
AEConstants.REACHED_LAST_PAGE = "LastPage"

AEConstants.OUTFITS = "Outfits"
AEConstants.PRESET_COSTUMES = "PresetCostumes"
AEConstants.EMOTES = "Emotes"
...
AEConstants.AvatarSettings = {
	proportionsAndBodyTypeEnabledForUser = "proportionsAndBodyTypeEnabledForUser",
...
AEConstants.WarningType = {
	CONNECTION = 1,
	DEFAULT_CLOTHING = 2, -- AvatarEditorRemoveDefaultClothingMessage - Remove when flag is removed
	R6_SCALES = 3,
	R6_ANIMATIONS = 4,
}
...
AEConstants.EmotesPages = 8

AEConstants.EmotesConstants = {
	EmotesPerPage = 8,
	...
	SlotNumberSize = 0.35,
	SlotNumberOffset = 0.025,
}

AEConstants.GamepadNavigationMenuLevel = {
	CategoryMenu = 1,
	TabList = 2,
	AssetsPage = 3,
}
