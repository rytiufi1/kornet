...
function AEWarningWidget:render()
	...
	local themeInfo = FFlagAvatarEditorGothamFont and
		self._context.AvatarEditorTheme.AEWarningWidget:getThemeInfo(nil, themeName) or nil
	...
	return Roact.createElement("ImageLabel", {
		...
		WarningText = Roact.createElement(LocalizedTextLabel, {
			...
			TextTransparency = 0,
			BorderSizePixel = 0,
			Position = FFlagAvatarEditorGothamFont and UDim2.new(0, 62, 0, 5) or UDim2.new(0, 62, 0, 0),
			Size = FFlagAvatarEditorGothamFont and UDim2.new(1, -85, 1, -10) or UDim2.new(1, -85, 1, 0),
		}, {
