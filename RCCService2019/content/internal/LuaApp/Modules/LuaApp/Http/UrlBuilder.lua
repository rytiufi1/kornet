...
local GameUrlPatterns = require(Modules.LuaApp.Http.UrlPatterns.GameUrlPatterns)
local UserUrlPatterns = require(Modules.LuaApp.Http.UrlPatterns.UserUrlPatterns)
local StaticUrlPatterns = require(Modules.LuaApp.Http.UrlPatterns.StaticUrlPatterns)
