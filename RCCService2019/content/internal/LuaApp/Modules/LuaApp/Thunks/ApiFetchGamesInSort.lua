...
local FFlagLuaAppUseGameSetTargetId = settings():GetFFlag("LuaAppUseGameSetTargetId")
...
return function(networkImpl, sort, isAppend, optionalSettings)
	return function(store)
		...
		if FFlagLuaAppUseGameSetTargetId then
			argTable.gameSetTargetId = sort.gameSetTargetId
		end
