...
local function checkIfWarningIsOpen(warningInformation, warningType)
	-- FFlagAvatarEditorRemoveDefaultClothingMessage - Remove once flag is removed
...
return function(open, warningType)
	return function(store)
		spawn(function()
			...
			if not FFlagAvatarEditorRemoveDefaultClothingMessage and open and warningType == AEConstants.WarningType.DEFAULT_CLOTHING then
