...
local FFlagAvatarEditorKeepYourColor = settings():GetFFlag("AvatarEditorKeepYourColor")
	...
	return function(store)
		...
		if fullReset then
			...
			if not FFlagAvatarEditorKeepYourColor or
				(FFlagAvatarEditorKeepYourColor and not AEUtils.isPresetCostume(outfit)) then
