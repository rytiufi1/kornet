...
local function loginByPhone(networkImpl, cvalue, password)
	return function(store)
		return LoginRequests.logByPhone(networkImpl, cvalue, password):andThen(
			function(result)
			...
			function(err)
				...
				if body.errors[1].code == LoginErrorCodes.IncorrectCValueOrPassword then
					return Promise.reject("Authentication.Login.Response.IncorrectPhoneOrPassword")
