...
local AEEquippedEmotes = require(Reducers.AEEquippedEmotes)
...
local AEAccessoryChangeOnModel = require(Reducers.AEAccessoryChangeOnModel)
local AEGamepadNavigationMenuLevel = require(Reducers.AEGamepadNavigationMenuLevel)
...
return function(state, action)
	...
	return {
		...
		AEEquippedEmotes = AEEquippedEmotes(state.AEEquippedEmotes, action),
		...
		AEAccessoryChangeOnModel = AEAccessoryChangeOnModel(state.AEAccessoryChangeOnModel, action),
		AEGamepadNavigationMenuLevel = AEGamepadNavigationMenuLevel(state.AEGamepadNavigationMenuLevel, action),
