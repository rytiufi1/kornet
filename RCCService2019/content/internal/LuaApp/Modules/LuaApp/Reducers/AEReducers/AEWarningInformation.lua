...
return function(state, action)
	...
	if action.type == AESetWarningInformation.name then
		...
		elseif action.warningType == AEConstants.WarningType.DEFAULT_CLOTHING
			and not FFlagAvatarEditorRemoveDefaultClothingMessage then
	...
	if action.type == AESetConnectionState.name then
