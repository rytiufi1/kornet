...
local function useLastOnlineForSort(lastOnline1, lastOnline2)
	return typeof(lastOnline1) == "number" and typeof(lastOnline2) == "number" and lastOnline1 ~= lastOnline2
end
...
return function (friend1, friend2)
	...
	if friend1Weight == friend2Weight then
		if friend1.presence ~= User.PresenceType.OFFLINE and useLastOnlineForSort(friend1.lastOnline, friend2.lastOnline) then
