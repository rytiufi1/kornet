...
--[[ Badges ]]--
	...
	local function setDescriptionDisplay(isExperimental)
		...
		if isExperimental then
			...
			createTextLabel(text, "ExperiementalText", 1)
		end
		...
		DescriptionScrollingTextBox:SetLayoutOrder(2)
	end
	...
	do
		...
		local function loadDescriptionDataAsync()
			...
			setDescriptionDisplay(data.IsExperimental)
