...
local function createBaseGrid(size, images, imageContainerSizeY)
	...
	function this:SetPlaceIds(sortData, sortName, gameSort)
		if sortData then
			for i = 1, #images do
				local placeId = sortData[i] and sortData[i].placeId or nil
			...
			shouldShowMoreButton = #sortData > #images
			moreButton.Visible = shouldShowMoreButton
