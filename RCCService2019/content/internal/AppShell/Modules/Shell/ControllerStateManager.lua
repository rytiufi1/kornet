...
local XboxHideLostControllerDialogWhenKeyboardAndMouseEnabled = settings():GetFFlag("XboxHideLostControllerDialogWhenKeyboardAndMouseEnabled")
...
local function isGamepadInputType(inputType)
	return
		inputType == Enum.UserInputType.Gamepad1 or
		inputType == Enum.UserInputType.Gamepad2 or
		inputType == Enum.UserInputType.Gamepad3 or
		inputType == Enum.UserInputType.Gamepad4 or
		inputType == Enum.UserInputType.Gamepad5 or
		inputType == Enum.UserInputType.Gamepad6 or
		inputType == Enum.UserInputType.Gamepad7 or
		inputType == Enum.UserInputType.Gamepad8
end

local function onLostUserGamepad(dataModelType)
	if XboxHideLostControllerDialogWhenKeyboardAndMouseEnabled then
		if not isGamepadInputType(UserInputService:GetLastInputType()) then
			return
		end
	end
