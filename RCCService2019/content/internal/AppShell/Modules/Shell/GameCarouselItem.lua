...
local function GameCarouselItem(size, sortName, getGameCollection, onNewGameSelected, hasResultsChanged)
	...
	function this:Init(Transparency)
		...
		myCarouselView:SetItemSizePercentOfContainer(0.86)
	...
	function this:Focus()
		...
		if this then
			if locked then
				if myCarouselController then
					local placeId = myCarouselController:GetFrontGameData() and myCarouselController:GetFrontGameData().placeId or nil
					onNewGameSelected(placeId, true)
				end
