...
local Errors =
{
	...
	GameJoin =
	{
		...
		-- 119 failed to get the session on invite/join through MPSD
		[18] = { Title = Strings:LocalizedString("UnableToJoinTitle"), Msg = Strings:LocalizedString("InstanceNotFound"), Code = 119 },
	...
	Authentication =
	{
		...
		[19] = { Title = Strings:LocalizedString("ReauthMaintenanceTitle"), Msg = Strings:LocalizedString("ReauthMaintenancePhrase"), Code = 920 },
	},
