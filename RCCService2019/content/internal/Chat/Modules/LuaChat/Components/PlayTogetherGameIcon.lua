...
local FFlagLuaChatPlayTogetherTopGameIconMissingSOC3584 = settings():GetFFlag("LuaChatPlayTogetherTopGameIconMissingSOC3584")
...
function PlayTogetherGameIcon.new(appState, conversation, iconSize, iconType)
    ...
    self.rbx.TopGameIcon.Activated:Connect(function()
        self.Pressed:fire()
    end)
...
function PlayTogetherGameIcon:Update(conversation)
    if FFlagLuaChatPlayTogetherTopGameIconMissingSOC3584 and not self.rbx then
        return
    end
