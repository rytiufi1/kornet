...
function ConversationSearchBox.new(appState)
	...
	search.FocusLost:Connect(function()
		if search.Text:len() == 0 then
			if FFlagLuaChatFixConversationHubHeaders then
				-- wait a frame to deal with input propagation issues
				-- with the activated event. don't do this if you have
				-- self-respect. love, Andrew
	...
	clearSearchButton.Activated:Connect(function()
		search.Text = ""
		self:Cancel()
	end)
