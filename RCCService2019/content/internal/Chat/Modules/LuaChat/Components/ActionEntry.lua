...
function ActionEntry.new(appState, icon, localizationKey, size)
	...
	local labelEffectiveWidth = Text.GetTextWidth(text, Constants.Font.STANDARD, Constants.Font.FONT_SIZE_18) + LABEL_SPACING
...
function ActionEntry:AdjustLayout()
	...
	local valueWidth = Text.GetTextWidth(text, Constants.Font.STANDARD, Constants.Font.FONT_SIZE_18)
