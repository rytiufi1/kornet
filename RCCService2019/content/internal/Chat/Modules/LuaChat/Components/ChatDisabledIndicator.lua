...
function ChatDisabledIndicator.new(appState)
	...
	local ibtWidth = Text.GetTextWidth(imageButtonText, Constants.Font.STANDARD, Constants.Font.FONT_SIZE_16)
	...
	self.rbx.IndicatorInner.PrivacySettings.Activated:Connect(function()
