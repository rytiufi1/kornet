return function()
	...
	local SendButton = require(script.Parent.SendButton)

	describe("lifecycle", function()
		it("should mount and unmount without issue", function()
			local _, cleanup = mountStyledFrame(Roact.createElement(SendButton))
	...
	describe("prop LayoutOrder", function()
		it("should set the top level GuiObject LayoutOrder", function()
			...
			local tree = Roact.createElement(SendButton, {
	...
	describe("props fullExtents", function()
		it("should remain a 1:1 aspect ratio", function()
			...
			local tree1 = mockStyle(Roact.createElement(SendButton, {
				fullExtents = mockExtents1,
			}))
			local tree2 = mockStyle(Roact.createElement(SendButton, {
				fullExtents = mockExtents2,
			}))
			local tree3 = mockStyle(Roact.createElement(SendButton, {
