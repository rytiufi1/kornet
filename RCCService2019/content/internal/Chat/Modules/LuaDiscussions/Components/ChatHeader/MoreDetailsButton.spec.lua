return function()
	...
	local MoreDetailsButton = require(script.Parent.MoreDetailsButton)

	describe("lifecycle", function()
		it("should mount and unmount without issue", function()
			local _, cleanup = mountStyledFrame(Roact.createElement(MoreDetailsButton))
	...
	describe("prop LayoutOrder", function()
		it("should set the top level GuiObject LayoutOrder", function()
			...
			local tree = Roact.createElement(MoreDetailsButton, {
	...
	describe("props fullExtents", function()
		it("should remain a 1:1 aspect ratio", function()
			...
			local tree1 = mockStyle(Roact.createElement(MoreDetailsButton, {
				fullExtents = mockExtents1,
			}))
			local tree2 = mockStyle(Roact.createElement(MoreDetailsButton, {
				fullExtents = mockExtents2,
			}))
			local tree3 = mockStyle(Roact.createElement(MoreDetailsButton, {
