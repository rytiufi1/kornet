...
public static async Task<Stream> RequestTextureThumbnail(long assetId, object? extra = null, CancellationToken? ct = null) 
    => await RenderWithArgs("Texture", new object[] { MakeAssetUrl(assetId), "Png", 420, 420 }, "Png", ct);

public static async Task<Stream> RequestAssetThumbnail(long assetId, object? extra = null, CancellationToken? ct = null) 
    => await RenderWithArgs("Asset", new object[] { MakeAssetUrl(assetId), "Png", 420, 420 }, "Png", ct);

public static async Task<Stream> RequestAssetMesh(long assetId, object? extra = null, CancellationToken? ct = null) 
    => await RenderWithArgs("Mesh", new object[] { MakeAssetUrl(assetId) }, "Obj", ct);

public static async Task<Stream> RequestHeadThumbnail(long assetId, object? extra = null, CancellationToken? ct = null) 
